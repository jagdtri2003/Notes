...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (noteUpdated === "true") {
    document.getElementById("toast-content").innerText =
    ...
    toastLiveExample.style.boxShadow =
      " 0 0 1px #740606,0 0 1px #740606,0 0 3px #740606,0 2px 0 #740606";
    toastBootstrap.show();
    localStorage.removeItem("noteDeleted");
  }
});

const openShareModel = (title, content) => {
